...
# /Users/ptr/Development/ACES/amf-util/scripts/../Material/amf/S-Log3S-Gamut3-Rec.2020ST20841000nits.amf
# created by amf-util 0.0.2
# transforms:
#   IDT: IDT.Sony.SLog3_SGamut3.a1.v1 (ACES 1.0 Input - Sony SLog3 SGamut3)
#   RRT: RRT.a1.0.3 (ACES 1.0 - RRT)
#   ODT: ODT.Academy.Rec2020_100nits_dim.a1.0.3 (ACES 1.0 Output - Rec.2020)
...
$CTLRENDER \
     ...
     -param1 aIn 1.0 \
     -ctl /Users/ptr/Development/ACES/amf-util/scripts/../../ACES-LUTs/aces-dev-1.2.0/transforms/ctl/odt/rec2020/ODT.Academy.Rec2020_100nits_dim.ctl \
     -param1 aIn 1.0 \
     -force \
     "$INPUTIMAGEPATH" \
     "$OUTPUTIMAGEPATH"
